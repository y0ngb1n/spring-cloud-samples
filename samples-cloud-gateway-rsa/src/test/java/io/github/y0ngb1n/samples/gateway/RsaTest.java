...
public class RsaTest {
  ...
  public void test_encrypt() {
    ...
    System.out.println(RsaUtils.decryptPublicKey(RsaUtils.encryptPrivateKey(str, PRIVATE_KEY), PUBLIC_KEY));
    System.out.println(encrypt);
  }

  @Test
  public void test_decrypt() {
    String decrypt = RsaUtils.decrypt(
